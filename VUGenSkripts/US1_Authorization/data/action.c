Action()
{
	...
	web_websocket_send("ID=0", 
		"Buffer={\"messageType\":\"hello\",\"broadcasts\":{\"remote-settings/monitor_changes\":\"\\\"1731769029930\\\"\"},\"use_webpush\":true}", 
		"IsBinary=0", 
		LAST);

	/*Connection ID 0 received buffer WebSocketReceive0*/

	lr_start_transaction("US1_Autorization");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.2.1731789014.4.1.1731789114.43.0.0; DOMAIN=www.advantageonlineshopping.com");

	web_add_cookie("_gid=GA1.2.114201075.1731778528; DOMAIN=www.advantageonlineshopping.com");

	web_add_cookie("_ga_TBPYED8WSW=GS1.1.1731789014.4.1.1731789510.0.0.0; DOMAIN=www.advantageonlineshopping.com");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.2.1731789014.4.1.1731789515.56.0.0; DOMAIN=www.advantageonlineshopping.com");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.2.1731789014.4.1.1731789511.60.0.0; DOMAIN=www.advantageonlineshopping.com");
	...
	web_add_cookie("_ga_56EMNRF2S2=GS1.2.1731789014.4.1.1731789537.34.0.0; DOMAIN=www.advantageonlineshopping.com");
	...
	lr_end_transaction("US1_Autorization",LR_AUTO);
